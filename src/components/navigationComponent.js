...
const SecondRoute = () =>
    <View onPress={this.isImmersive ? this.setImmersiveOff : this.setImmersiveOn} style={[styles.container, { backgroundColor: '#fff' }]}>
...
export default class NavigatorComponent extends Component {
        ...
        state = {
            index: 1,
            routes: [
                { key: 'first', icon:'gears' },
                { key: 'second', icon:'home'},
                { key: 'third', icon:'search' },
            ],
            isImmersive: false,
    ...
    getImmersiveState = () => Immersive.getImmersive().then((immersiveState) => {
